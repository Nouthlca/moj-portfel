...
# ----------------------------------------------------
# FUNKCJA GENERUJĄCA WYKRES TRENDU I DOPŁAT
# ----------------------------------------------------
def pokaz_wykres_i_historie_konta(nazwa_konta, kolor_glowny):
    ...
    if not df_konta.empty:
        # Wykres Kombinowany (Słupki Dopłat + Linia Trendy Wartości)
        fig = go.Figure()

        # 1. Słupki reprezentujące dopłaty
        ...
        # 2. Linia reprezentująca wzrost wartości konta
...
# ----------------------------------------------------
    ...
    # DEDYKOWANA HISTORIA I WYKRES DOPŁAT
