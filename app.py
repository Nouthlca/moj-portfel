...
def formularz_pozycji(prefix_konta, domyslny_ticker, domyslne_sztuki, domyslna_cena):
    ...
    # Precyzja do 4 miejsc po przecinku
...
with tab_wykresy:
    ...
    if wszystkie_dane_wykres:
        ...
        with col_w1:
            ...
            fig_pie = px.pie(df_wykres, values="Wartość PLN", names="Nazwa", hole=0.4)
        ...
        with col_w2:
            ...
            fig_bar = px.bar(df_konta, x="Konto", y="Wartość PLN", color="Konto", text_auto='.2f')
